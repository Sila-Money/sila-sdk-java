...
#### Get Account Balance
Requests bank account balance data from Plaid.
...
System.out.println(((TransactionResponse) response.getData()).getDescriptor()); // Descriptor added in request.
```
...
```java
System.out.println(response.getStatusCode()); // 200
System.out.println(((TransferSilaResponse) response.getData()).getReference()); // Random reference number
System.out.println(((TransferSilaResponse) response.getData()).getStatus()); // SUCCESS
System.out.println(((TransferSilaResponse) response.getData()).getMessage()); // Transaction submitted to processing queue.
System.out.println(((TransferSilaResponse) response.getData()).getDescriptor()); // Descriptor added in request.
```
#### RedeemSila
