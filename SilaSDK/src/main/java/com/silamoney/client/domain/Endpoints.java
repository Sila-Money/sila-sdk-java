...
public enum Endpoints {
    ...
    GET_WALLET("/get_wallet"), REGISTER_WALLET("/register_wallet"),
    ...
    DELETE_ACCOUNT("/delete_account"), LINK_CARD("/link_card"), DELETE_CARD("/delete_card"),
    ...
    GET_INSTITUTIONS("/get_institutions"), UPDATE_ACCOUNT("/update_account"),
    CHECK_PARTNER_KYC("/check_partner_kyc"), GET_WALLET_STATEMENT_DATA("/get_wallet_statement_data"),
    GET_STATEMENTS_DATA("/get_statements_data"), GET_STATEMENT_TRANSACTIONS("/get_statement_transactions"), STATEMENTS("/statements"),
