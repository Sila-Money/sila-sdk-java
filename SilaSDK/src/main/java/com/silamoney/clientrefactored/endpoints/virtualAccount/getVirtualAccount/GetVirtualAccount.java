...
public class GetVirtualAccount extends AbstractEndpoint {

        private static Logger logger = Logger.getLogger(GetVirtualAccount.class.getName());

        private static final String ENDPOINT = "/get_virtual_account";

        private GetVirtualAccount() {
        }

        public static ApiResponse send(GetVirtualAccountRequest request)
                ...
                try {
                        return ResponseUtils.prepareResponse(GetVirtualAccountResponse.class,
