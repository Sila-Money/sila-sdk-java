...
public class RegisterBusinessTests {
	...
	public void Response200() throws Exception {
		...
		BusinessUser user = new BusinessUser(DefaultConfigurations.getBusinessHandle(), "Office", "123 Main Street", null, "New City",
				"OR", "97204-1234", "503-123-4567", "example@silamoney.com", "123452222",
				DefaultConfigurations.getBusinessCryptoAddress(), "entity name", businessType, "https://www.website.com",
				"doing business as", naicsCategory);
